...
def fc(layer_input, output_size, is_training, activation_fn=tf.nn.tanh,
       use_batch_norm=False, scope='fc'):
    if use_batch_norm:
        batch_norm_args = {'normalizer_fn': batch_norm,
                           'normalizer_params': {'is_training': is_training, }}
    else:
        batch_norm_args = {}

    with tf.variable_scope(scope):
        return fully_connected(layer_input, num_outputs=output_size, activation_fn=activation_fn,
